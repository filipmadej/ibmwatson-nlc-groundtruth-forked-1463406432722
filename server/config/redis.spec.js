...
describe('/server/config/redis', function () {
  ...
  it('should not configure redis if service not available', function () {
    ...
    this.appEnvMock.getService.should.have.been.calledWith('ibmwatson-nlc-redis');
  ...
  it('should reuse created client', function () {
    ...
    var initialClient = redisUtil();

    this.redisMock.createClient.should.have.been.called;

    var subsequentClient = redisUtil();

    this.redisMock.createClient.should.have.been.calledOnce;
    initialClient.should.equal(subsequentClient);
