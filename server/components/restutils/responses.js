...
function buildLocation (template, parameters) {
  var location = template;
  Object.keys(parameters).forEach(function substituteId (id) {
    location = location.replace(id, parameters[id]);
  });
  return location;
}
...
module.exports.newitem = function newitem (object, locationtemplate, locationids, res) {
  var location = buildLocation(locationtemplate, locationids);
...
module.exports.accepted = function accepted (locationtemplate, locationids, res) {
  var location = buildLocation(locationtemplate, locationids);
